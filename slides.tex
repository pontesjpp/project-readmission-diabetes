...
\begin{frame}{Achado metodológico: SMOTE não é gratuito}
...
\begin{itemize}
  \item \textbf{Top do ranking} dentre as 29+ combinações avaliadas. SVM 2º (0.4471) — empate técnico no nível ($\Delta$=0.004, Wilcoxon p=0.31).
  ...
  \item Variantes testadas em RF: \textbf{SMOTE atrapalha} (--0.021, p$<$0.001), \emph{Robust empata}, TargetEnc atrapalha (--0.007).
\end{itemize}
\end{frame}
