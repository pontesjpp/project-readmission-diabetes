...
\begin{frame}{Comparação baseline vs variantes — Wilcoxon e paired t}
\textbf{Critério de promoção:} diferença positiva \emph{e} p<0.05 em Wilcoxon ou paired t-test (5 folds pareados, mesmos folds entre baseline e variante).
...
\midrule
\rowcolor{green!10}
LVQ           & \textbf{Undersample} & 0.2648 & \textbf{0.4168} & \textbf{+0.1520} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{green!10}
LVQ           & SMOTE        & 0.2648 & \textbf{0.3921} & \textbf{+0.1273} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{green!10}
Decision Tree & SMOTE        & 0.4012 & \textbf{0.4190} & \textbf{+0.0178} & 0.063 & \textbf{0.007}$^{*}$ \\
\rowcolor{green!10}
LVQ           & TargetEnc    & 0.2648 & 0.2721 & \textbf{+0.0072} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{green!10}
LVQ           & RobustScaler & 0.2648 & 0.2719 & \textbf{+0.0071} & 0.063 & \textbf{0.003}$^{*}$ \\
\rowcolor{green!10}
Decision Tree & TargetEnc    & 0.4012 & 0.4067 & \textbf{+0.0055} & 0.063 & \textbf{0.042}$^{*}$ \\
\rowcolor{green!10}
LightGBM      & SMOTE        & 0.4204 & 0.4253 & \textbf{+0.0049} & 0.063 & \textbf{0.016}$^{*}$ \\
\midrule
Random Forest & RobustScaler & 0.4512 & 0.4513 & +0.0001 & 0.81 & 0.92 \\
SVM           & RobustScaler & 0.4471 & 0.4472 & +0.0001 & 0.31 & 0.13 \\
LightGBM      & RobustScaler & 0.4204 & 0.4208 & +0.0003 & 1.00 & 0.37 \\
XGBoost       & RobustScaler & 0.4240 & 0.4240 & +0.0000 & 1.00 & 1.00 \\
XGBoost       & SMOTE        & 0.4240 & 0.4259 & +0.0019 & 0.44 & 0.33 \\
\midrule
\rowcolor{red!10}
Random Forest & SMOTE        & 0.4512 & 0.4298 & \textbf{--0.0214} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{red!10}
SVM           & SMOTE        & 0.4471 & 0.4277 & \textbf{--0.0195} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{red!10}
Random Forest & Undersample  & 0.4512 & 0.4328 & \textbf{--0.0184} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{red!10}
SVM           & Undersample  & 0.4471 & 0.4338 & \textbf{--0.0133} & 0.063 & \textbf{$<$0.001}$^{*}$ \\
\rowcolor{red!10}
Random Forest & TargetEnc    & 0.4512 & 0.4439 & --0.0074 & 0.063 & \textbf{0.005}$^{*}$ \\
\rowcolor{red!10}
SVM           & TargetEnc    & 0.4471 & 0.4410 & --0.0061 & 0.063 & \textbf{0.001}$^{*}$ \\
\rowcolor{red!10}
XGBoost       & TargetEnc    & 0.4240 & 0.4210 & --0.0030 & 0.063 & \textbf{0.045}$^{*}$ \\
\bottomrule
\end{tabular}

\vspace{0.3em}
\scriptsize $^{*}$ = p<0.05 em paired t-test. Wilcoxon com 5 folds é \emph{conservador} (p mínimo possível = 0.0625).

\vspace{0.3em}
\footnotesize \textbf{Verde:} variante promovida. \textbf{Vermelho:} variante atrapalha. Outros: empate técnico.
\end{frame}
...
\vspace{0.6em}
\textbf{Robust e TargetEnc na maioria dos modelos:} efeito praticamente nulo. Árvores são insensíveis a escala (esperado); TargetEncoder em colunas como \texttt{payer\_code} não compensa a perda de granularidade vs OHE esparso quando há features OHE de baixa cardinalidade abundantes.
\end{frame}
